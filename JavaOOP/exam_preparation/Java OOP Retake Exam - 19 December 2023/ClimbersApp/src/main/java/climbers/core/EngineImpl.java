...
public class EngineImpl implements Engine{
    ...
    private final Scanner scanner;
        ...
        @Override
        public String addClimber(String[] data) {
            return controller.addClimber(data[0], data[1]);
        }

    @Override
    public String addMountain(String[] data) {
    ...
    @Override
    public String removeClimber(String[] data) {
            return controller.removeClimber(data[0]);
        }

    @Override
    public String startClimbing(String[] data) {
