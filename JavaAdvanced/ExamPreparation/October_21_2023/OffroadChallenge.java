package ExamPreparation.October_21_2023;
...
public class OffroadChallenge {
    ...
    public static void main(String[] args) {
        ...
        Deque<Integer> consumptionIndex = Arrays.stream(scanner.nextLine().split(" "))
                .mapToInt(Integer::parseInt)
                .boxed().collect(Collectors.toCollection(LinkedList::new));

        Deque<Integer> neededFuelAmount = Arrays.stream(scanner.nextLine().split(" "))
                .mapToInt(Integer::parseInt)
                .boxed().collect(Collectors.toCollection(LinkedList::new));
